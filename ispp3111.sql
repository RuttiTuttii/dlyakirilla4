USE [master]
GO
/****** Object:  Database [ispp3111]    Script Date: 16.10.2025 11:50:36 ******/
CREATE DATABASE [ispp3111]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ispp3111', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQL\MSSQL\DATA\ispp3111.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ispp3111_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQL\MSSQL\DATA\ispp3111_log.ldf' , SIZE = 2304KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [ispp3111] SET COMPATIBILITY_LEVEL = 160
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [ispp3111].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [ispp3111] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [ispp3111] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [ispp3111] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [ispp3111] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [ispp3111] SET ARITHABORT OFF 
GO
ALTER DATABASE [ispp3111] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [ispp3111] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [ispp3111] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [ispp3111] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [ispp3111] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [ispp3111] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [ispp3111] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [ispp3111] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [ispp3111] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [ispp3111] SET  ENABLE_BROKER 
GO
ALTER DATABASE [ispp3111] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [ispp3111] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [ispp3111] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [ispp3111] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [ispp3111] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [ispp3111] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [ispp3111] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [ispp3111] SET RECOVERY FULL 
GO
ALTER DATABASE [ispp3111] SET  MULTI_USER 
GO
ALTER DATABASE [ispp3111] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [ispp3111] SET DB_CHAINING OFF 
GO
ALTER DATABASE [ispp3111] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [ispp3111] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [ispp3111] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [ispp3111] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'ispp3111', N'ON'
GO
ALTER DATABASE [ispp3111] SET QUERY_STORE = ON
GO
ALTER DATABASE [ispp3111] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [ispp3111]
GO
...
GO
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (11, N'a3423432', N'2 213     ', CAST(N'2025-09-26T10:08:32.220' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (13, N'ivan@example.com', N'9991234567', CAST(N'2025-10-02T11:02:47.180' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (15, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:03:07.920' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (16, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:04:40.363' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (19, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:26:34.553' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (20, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:33:17.240' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (17, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:05:37.363' AS DateTime), N'ispp3111')
INSERT [dbo].[DeletedVisiors] ([VisiorId], [Email], [Phone], [DeleteDate], [DeletedBy]) VALUES (18, N'markPetr@example.com', N'9901234567', CAST(N'2025-10-02T11:06:25.023' AS DateTime), N'ispp3111')
GO
...
USE [master]
GO
ALTER DATABASE [ispp3111] SET  READ_WRITE 
GO
